...
const need = "*Link Idu Ennit Athin mension vech adikk🦋*"
...
if (Config.WORKTYPE == 'private') {
  ...
  Raashii.addCommand({ pattern: 'spdf ?(.*)', fromMe: true, desc: 'Get screenshot of links in pdf'}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer.from(rashi.data), MessageType.document, { filename: 'Lizamwol.pdf', mimetype: Mimetype.pdf});
