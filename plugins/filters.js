...
Asena.addCommand({on: 'text', fromMe: false }, (async (message, match) => {
    if(Config.BGMFILTER){
        ...
        if (!!message.mention && message.mention[0] == '918137829228@s.whatsapp.net','918075379950@s.whatsapp.net') {
